...
reasoning_model_id = os.getenv("REASONING_MODEL_ID", "DeepSeek-R1-Distill-Llama-70B")  # GPT-4 Turbo for reasoning
tool_model_id = os.getenv("TOOL_MODEL_ID", "gpt-3.5-turbo")  # GPT-3.5 for tool calling
...
def rag_with_reasoner(user_query: str) -> str:
    ...
    # Refined prompt to handle insufficient information
